...
const MARAIS = [
  ...
  scene({
    ...
    description:
      'Deux nappes de brume ondulées voilent la berge ; en dessous, l’eau, un saule et son ' +
    ...
    zones: [
      ...
      z('saule-de-la-berge', 'le saule de la berge', F.lobe(220, 288, 122, 6, 0.7, 44, 0.5, 0.75)),
      z('tronc-du-saule', 'le tronc du saule', F.ruban([[230, 370], [238, 452]], 30)),
      ...
      z('barque-echouee', 'la barque échouée', F.poser('barque', 600, 400, 202, 92)),
      z('nenuphar-perdu', 'le nénuphar perdu', F.poser('nenuphar', 818, 428, 122, 98)),
      z('route', 'la route', F.ruban([[0, 540], [300, 510], [620, 532], [960, 506]], 58)),
      z('roue', 'la roue', F.anneau(150, 522, 46, 22)),
      z('caillou', 'le caillou', F.lobe(862, 552, 48, 4, 0.8, 32, 0.9, 0.6)),
    ],
...
const FORET = [
  ...
  scene({
    ...
    description:
      'Trois troncs droits de trois largeurs, et au sol quatre feuilles dentelées de quatre ' +
    ...
    zones: [
      ...
      z('gland-du-tapis', 'le gland du tapis', F.poser('gland', 408, 400, 66, 92)),
      z('feuille-du-tapis-un', 'la première feuille du tapis', F.poser('feuilleDentee', 140, 430, 142, 122)),
      z('feuille-du-tapis-deux', 'la deuxième feuille du tapis', F.poser('feuilleDentee', 320, 480, 112, 98)),
      z('feuille-du-tapis-trois', 'la troisième feuille du tapis', F.poser('feuilleDentee', 560, 432, 162, 138)),
      z('feuille-du-tapis-quatre', 'la quatrième feuille du tapis', F.poser('feuilleDentee', 750, 492, 96, 84)),
      z('feuille-basse', 'la feuille basse', F.poser('feuilleDentee', 40, 500, 104, 90)),
      z('feuille-haute', 'la feuille haute', F.poser('feuilleDentee', 860, 440, 90, 78)),
    ],
...
const VOLCAN = [
  ...
  scene({
    ...
    description:
      'L’enclume à corne posée sur son billot, le marteau de forge à côté, le foyer en anneau ' +
    ...
    zones: [
      ...
      z('rideau', 'le rideau', [[0, 60], [120, 48], [112, 470], [0, 488]]),
      z('tableau', 'le tableau', F.rect(160, 120, 200, 130)),
      z('drapeau', 'le drapeau', F.poser('drapeau', 390, 110, 152, 122)),
      z('oiseau', 'l’oiseau', F.poser('oiseau', 580, 100, 162, 112)),
      z('chapeau', 'le chapeau', F.poser('chapeau', 790, 110, 132, 102)),
      z('enclume', 'l’enclume', F.poser('enclume', 150, 300, 222, 152)),
      z('billot', 'le billot', F.trapeze(260, 452, 172, 214, 86)),
      z('marteau-de-forge', 'le marteau de forge', F.poser('marteau', 400, 268, 112, 162)),
      ...
      z('feu', 'le feu', F.flammes(620, 780, 466, 106, 4, 16)),
      z('seau', 'le seau', F.trapeze(900, 404, 76, 60, 68)),
...
const CITE = [
  ...
  scene({
    ...
    description:
      'Un grand cadre en anneau sur un mur de pierre, trois scènes de trois formats à ' +
    ...
    zones: [
      ...
      z('ciel', 'le ciel', F.rect(100, 110, 760, 92)),
      z('soleil', 'le soleil', F.etoile(790, 152, 46, 24, 12)),
      z('arbre', 'l’arbre', F.poser('arbre', 104, 150, 128, 238)),
      z('feuille', 'la feuille', F.poser('feuilleDentee', 296, 132, 78, 88)),
      ...
      z('mur', 'le mur', F.rect(520, 290, 242, 140)),
      z('porte', 'la porte', F.arche(600, 430, 78, 98)),
      z('fleur', 'la fleur', F.lobe(430, 400, 42, 5, 0.45, 40, 0.3, 1)),
      ...
      z('pot', 'le pot', F.trapeze(432, 516, 66, 50, 62)),
