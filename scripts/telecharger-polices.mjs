#!/usr/bin/env node
// Téléchargement des polices réellement distribuées — lot L2-B, v2 § 9.3, D9, D19.
//
...
const POLICES = [
  ...
  //
  //     réclamées par le CSS    : 6   (global.css 3, polices.css 3)
...
async function principal() {
  ...
  if (modeFiger) {
    ...
    console.log(
      `[polices] LICENCES.md régénéré depuis ${String(mesures.size)} fichier(s) mesuré(s).`,
    );
