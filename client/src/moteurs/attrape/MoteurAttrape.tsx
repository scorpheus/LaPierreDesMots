/**
 * `MoteurAttrape` — le composant hôte du moteur `attrape`. Lot L2-E.
 *
 * Il ne décide de RIEN. Toute la règle vit dans `moteurAttrape` (paquet `partage`) ; ce
 * composant fait quatre choses et pas une de plus : traduire un geste en `ActionAttrape`,
...
export function MoteurAttrape(
  ...
  return (
    ...
    >
      ...
      <div data-plateau="cibles" style={{ display: 'flex', flexWrap: 'wrap' }}>
        {contenu.cibles.map((cible) => (
          <button
            ...
            data-refusee={
              etat.dernierRefus !== null && etat.dernierRefus.cible === cible.id ? 'oui' : 'non'
            }
            style={STYLE_CIBLE}
            onClick={(evenement) => {
      ...
      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
        ...
        <button
          ...
          style={STYLE_CIBLE}
          onClick={() => {
            emettre({ type: 'ecouterConsigne' } as ActionAttrape);
          }}
        >
          Écouter
        </button>
        ...
        <button
          ...
          style={STYLE_CIBLE}
          onClick={() => {
            emettre({ type: 'demanderAide' } as ActionAttrape);
          }}
        >
          Gobi, aide-moi
        </button>
