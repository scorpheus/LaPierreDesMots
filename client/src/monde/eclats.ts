 ...
 * Les silhouettes de blocage restent ici comme repli déterministe, mais l’écran du coffre
 * charge désormais six PNG distincts générés dans le style du campement V6. Le même fichier
 * est montré en gris avant le gain, puis en couleur après le gain.
 *
...
export interface Eclat {
  /** Illustration raster propre à la région, utilisée dans le coffre et dans sa fiche. */
...
export const ECLATS: Readonly<Record<string, Eclat>> = {
  ...
  clairiere: {
    asset: 'assets/coffre/eclats/clairiere.png',
  ...
  'foret-muette': {
    asset: 'assets/coffre/eclats/foret-muette.png',
  ...
  'marais-jumeau': {
    asset: 'assets/coffre/eclats/marais-jumeau.png',
  ...
  galeries: {
    asset: 'assets/coffre/eclats/galeries.png',
  ...
  volcan: {
    asset: 'assets/coffre/eclats/volcan.png',
  ...
  'cite-des-histoires': {
    asset: 'assets/coffre/eclats/cite-des-histoires.png',
