/**
 * Schéma JSON 2020-12 du bloc `jeu.contenu` pour le moteur `libre` — lot L2-E.
 *
 ...
 *
 * Le schéma le plus court des treize, et c'est cohérent : il n'y a ni consigne, ni réponse,
 * ni critère. Il ne décrit qu'un décor et des couleurs offertes (v2 § 5.4).
 */
...
export const SCHEMA_CONTENU_LIBRE: SchemaJson = {
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  $id: 'pierre:schemas/contenu-libre',
  type: 'object',
  additionalProperties: false,
  required: ['regions', 'nuancierAutorise', 'competence'],
  properties: {
    regions: { type: 'array', minItems: 1, maxItems: 200, uniqueItems: true, items: ID },
    nuancierAutorise: {
      type: 'array',
      minItems: 1,
      maxItems: 11,
