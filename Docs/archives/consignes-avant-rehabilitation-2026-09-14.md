...
**Pilotage actif :** lire d'abord la section « Pilotage actif — 14 septembre 2026 » de
[l'état courant](Docs/etat-courant-et-file.md). Elle porte la file unique de finition F0–F5,
la répartition avec la campagne PWA en cours et les critères du site présentable. Les bilans
historiques situés après cette section ne valent pas état courant. La collecte manuelle des
défauts par le parent n'est pas un préalable aux contrôles automatiques de composition.
